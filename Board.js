const startBoard = (game, options = { playAgainst: 'human', aiColor: 'black', aiLevel: 'dumb' }) => {
    ...
    const resetBoard = () => {
        ...
        for (const piece of game.pieces) {
            ...
            square.innerHTML = `<img class="piece ${piece.rank}" id="${piece.name}" src="${piece.color}-${piece.rank}.webp">`;
        }
    ...
    game.on('promotion', queen => {
        ...
        square.innerHTML = `<img class="piece queen" id="${queen.name}" src="${queen.color}-queen.webp">`;
    })
